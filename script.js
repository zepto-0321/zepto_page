...
let senryu = [
  ["柿食えば","法隆寺","理論上","フクロウだ","てんぷら粉","@America","おいしいな","遣唐使","消費税","所得税","やりますねぇ","いとをかし","大切な","ハプニング","セル結合","5の精神","新時代","来たぞｺﾚ","デスピエロ","案の定","ここはどこ","賢吾君","ｺﾊｸﾝﾁｮｽ"],
  ["鐘が鳴るなり","1+1は","誕生日の","ハーブを添えて","暫定税率","罠(トラップ)カード","私の名前も","帯状疱疹","インフルエンザ","警戒態勢","粉塵爆発"]
];
